...
//                 val showCardholderName = cardConfig?.get("showCardholderName") as? Boolean ?:
// false
...
//                                         Log.d(
//                                                 "CardPlatformView",
//                                                 "handleSubmit called with sessionData:
// $sessionData"
//                                         )
...
//                                         // Log.d("CardPlatformView", "Payment success:
// $paymentID")
...
//                         try {
//                                 checkoutComponents =
//                                         CheckoutComponentsFactory(config =
...
//                                         }
//                                 } else {
//                                         // Log.e("CardPlatformView", "Card component not
// available")
//                                         sendError(
//                                                 "CARD_NOT_AVAILABLE",
...
//                                                         ?: 0XFF00639E,
//                                         colorFormBorder =
//                                                 (colorTokensMap?.get("colorFormBorder") as?
// Number)
//                                                         ?.toLong()
//                                                         ?: 0XFFCCCCCC,
...
//                         sendError(
//                                 "INIT_ERROR",
//                                 "Missing payment source ID - required for saved card CVV-only
// input"
//                         )
//                         return
//                 }
...
//                                                 Log.d(
//                                                         "CardPlatformView",
//                                                         "Stored card component initialized
// successfully"
//                                                 )
//                                         }
//                                 } else {
...
//                         Log.w("CardPlatformView", "Card component not initialized for
// validation")
//                         return false
//                 }
...
//         /**
//          * Tokenize the card - called from Flutter via method channel This is triggered
// exclusively
...
//                 if (!isInitialized || !::cardComponent.isInitialized) {
//                         val errorMsg =
//                                 "Card component not initialized - isInitialized: $isInitialized,
// cardComponent: ${::cardComponent.isInitialized}"
...
//                 try {
//                         Log.d("CardPlatformView", "About to launch coroutine on Main
// dispatcher...")
...
//                                                 Log.d(
//                                                         "CardPlatformView",
//                                                         "Calling cardComponent.submit() on
...
//                                         when (tokenData) {
//                                                 is
// com.checkout.components.interfaces.model.TokenDetails -> {
...
//                                 Log.d("CardPlatformView", "Payment success event sent to
// Flutter")
//                         } catch (e: Exception) {
//                                 Log.e(
//                                         "CardPlatformView",
